...
class TestExtend(unittest.TestCase):
    ...
    def test_add_a_b_return5(self):
        self.assertEqual(extend.add('maci','laci'),'macilaci')

    def test_add_a_b_return5_list(self):
        self.assertEqual(extend.add(['maci','laci'],['maci','laci']),['maci','laci','maci','laci'])
    ...
    def test_max_of_three_third_b_greater(self):
        self.assertEqual(extend.max_of_three(-3, 6, 5), 6)

    def test_max_of_three_third_c_greater(self):
        self.assertEqual(extend.max_of_three(5, 11, 12), 12)
